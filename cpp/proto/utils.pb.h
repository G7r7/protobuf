...
#ifndef GOOGLE_PROTOBUF_INCLUDED_proto_2futils_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_proto_2futils_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_proto_2futils_2eproto
...
struct TableStruct_proto_2futils_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2futils_2eproto;
namespace utils {
class Date;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::utils::Date* Arena::CreateMaybeMessage<::utils::Date>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace utils {
...
class Date PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:utils.Date) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_proto_2futils_2eproto);
    return ::descriptor_table_proto_2futils_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_proto_2futils_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Date::year() const {
  // @@protoc_insertion_point(field_get:utils.Date.year)
...
inline void Date::set_year(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:utils.Date.year)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Date::month() const {
  // @@protoc_insertion_point(field_get:utils.Date.month)
...
inline void Date::set_month(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:utils.Date.month)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Date::day() const {
  // @@protoc_insertion_point(field_get:utils.Date.day)
...
inline void Date::set_day(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:utils.Date.day)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_proto_2futils_2eproto
